...
private:
	...
	//std::vector<std::function<std::unique_ptr<Animation>(void)>> m_animationFactory; // needs a std::vector of std::function objects
...
public:
	...
	//	m_animationFactory.emplace_back(animationFactory);
	//}
